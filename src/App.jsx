...
function App() {
  const [isVoting, setIsVoting] = useState(false); // Example state to control voting phase
  const [isRegistration, setIsRegistration] = useState(true); // Example state to control registration phase
