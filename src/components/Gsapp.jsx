...
const navs = [
    ...
    { id: 2, title: 'Profile', link: './', icon: UilUser },
    { id: 3, title: 'Check Points', link: './', icon: UilPresentation },
    { id: 4, title: 'Redeem', link: './', icon: UilBill },
    { id: 5, title: 'History', link: './', icon: UilImages },
        ...
        <div >
            ...
            <motion.div
                ...
                <motion.button
                    ...
                    className={isHidden ? "p-2 absolute top-3 right-3 grid w-[50px] h-[40px] place-items-center bg-green-600 " : "z-50 p-2 absolute top-3 right-3 grid w-[50px] h-[50px] place-items-center bg-green-600 rounded "}
                >
                            ...
                            navs.map((nav, index) => (
                                <div key={index + 1}>
                                    <motion.li variants={itemVariants} className="font-normal font-poppins">
                                        <a href={nav.link} className="flex gap-5 lg:gap-10 items-center hover:text-green-500 hover:font-bolder hover:text-3x1">
